...
AutoScrollTreeView::AutoScrollTreeView(QWidget *parent)
    : QTreeView(parent)
{
...
void AutoScrollTreeView::scrollTo(const QModelIndex &index, QAbstractItemView::ScrollHint hint)
{
...
// fix it in Qt.
void AutoScrollTreeView::focusInEvent(QFocusEvent *event)
{
    if (event->reason() != Qt::PopupFocusReason)
        QTreeView::focusInEvent(event);
}

void AutoScrollTreeView::focusOutEvent(QFocusEvent *event)
{
    if (event->reason() != Qt::PopupFocusReason)
        QTreeView::focusOutEvent(event);
}

void AutoScrollTreeView::resizeEvent(QResizeEvent *event)
{
